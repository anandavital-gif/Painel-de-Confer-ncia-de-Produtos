const TAXES = [
  ...
  },
  {
    ...
    legislation: [
      ...
      { label: 'Convênios ICMS — CONFAZ', note: 'Legislação estadual' },
    ],
    rates: 'Alíquota varia por estado: 7% (SP→N/NE/CO), 12% (entre estados), 17–20% (interna).',
    authority: 'Secretarias de Fazenda Estaduais / CONFAZ',
    note: 'Verifique CEST para sujeição à Substituição Tributária (Convênio ICMS 92/2015). Pode haver benefícios fiscais estaduais.',
    linkLabel: 'CONFAZ — Legislação',
